    ...
    return (
        <div className=''>
            <h1 className='text-x mb-5'> 
                ...
                <Link to="/administration/depart_et_fil" className='hover:underline italic'>Gérer les éléments académiques </Link>
            </h1>
                ...
                <div className='font-medium flex-auto w-20 h-screen bg-blue-50 p-10 rounded-lg'>
                    ...
                    <div className='cursor-pointer'>
                        ...
                        <ul className='text-sm italic font-light pl-4 pb-2 mb-2 border-b-2'>
                            <li className={`${verify('form', 'ajout_departement') ? 'flex flex-row text-blue-600':'none'}`} onClick={() => handleFormSelection('ajout_departement')}>
                                    <CIcon className={`${verify('form', 'ajout_departement') ? 'block':'hidden'}`} icon={cilCaretRight} width={15} color='blue' />
